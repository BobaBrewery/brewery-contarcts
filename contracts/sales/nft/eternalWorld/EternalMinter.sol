...
contract EternalMinter is ReentrancyGuard {
    ...
    IAdmin public admin;
    IERC20 public USDT;
    uint256 public immutable rolePrice = 10000000000000000000;
    ...
    event RoleWhiteListed(address indexed buyer, uint256 amount);
    ...
    constructor(address _admin, address _propNft, address _usdt) public {
    ...
    function whitelist(
        ...
        emit RoleWhiteListed(msg.sender, amount);
    }
