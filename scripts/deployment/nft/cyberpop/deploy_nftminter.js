...
async function main() {
    ...
    const Minter = await hre.ethers.getContractFactory("CyberPopMinter");
    console.log('start deploy minter...');
    const minter = await Minter.deploy(admin_contract.address, PROP_ADDR);
    await minter.deployed();
    console.log("Minter deployed to: ", minter.address);
    saveContractAddress(hre.network.name, "CyberPopMinter", minter.address);
