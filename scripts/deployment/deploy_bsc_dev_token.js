...
async function main() {
    const tokenName = "BreweryDevTokenBSC";
    const symbol = "BREDTBSC";
    ...
    console.log("BREDTBSC deployed to: ", token.address);

    saveContractAddress(hre.network.name, "BREDTBSC", token.address);
}
